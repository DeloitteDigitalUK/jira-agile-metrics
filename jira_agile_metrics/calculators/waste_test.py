...
from ..conftest import FauxJIRA as JIRA, FauxIssue as Issue, FauxFieldValue as Value, FauxChange as Change
    ...
    return JIRA(
        ...
        issues=[
            ...
            Issue(
                ...
                changes=[Change("2018-01-09 02:02:02", [("status", "Backlog", "Done")])],
            ),
            Issue(
                "A-5",
                summary="Unresolved",
