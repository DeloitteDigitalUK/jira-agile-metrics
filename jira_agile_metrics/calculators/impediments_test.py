    ...
    return {
        CycleTimeCalculator: DataFrame(_issues([
            ...
            dict(Backlog=_ts('2018-01-02'), Committed=_ts('2018-01-03'), Build=NaT, Test=NaT, Done=NaT, blocked_days=4, impediments=[
                {'start': date(2018, 1, 5),  'end': date(2018, 1, 7),  'status': 'Backlog', 'flag': 'Impediment'},      # ignored because it was blocked in backlog
                {'start': date(2018, 1, 10), 'end': date(2018, 1, 12), 'status': 'Committed', 'flag': 'Impediment'},  # included
            ]),
            dict(Backlog=_ts('2018-01-03'), Committed=_ts('2018-01-03'), Build=_ts('2018-01-04'), Test=_ts('2018-01-05'), Done=_ts('2018-01-06'), blocked_days=4, impediments=[
                {'start': date(2018, 1, 4), 'end': date(2018, 1, 5),  'status': 'Build', 'flag': 'Impediment'},  # included
                {'start': date(2018, 1, 7), 'end': date(2018, 1, 10), 'status': 'Done', 'flag': 'Impediment'},  # ignored because it was blocked in done
            ]),
            dict(Backlog=_ts('2018-01-04'), Committed=_ts('2018-01-04'), Build=NaT, Test=NaT, Done=NaT, blocked_days=100, impediments=[
                {'start': date(2018, 1, 5), 'end': None, 'status': 'Committed', 'flag': 'Awaiting input'},  # open ended, still included
            ]),
