...
def settings(minimal_settings):
    return extend_dict(minimal_settings, {"throughput_frequency": "D", "throughput_window": None})
...
def test_calculate_throughput_with_wider_window(query_manager, settings, results):
    ...
    settings = extend_dict(settings, {"throughput_frequency": "D", "throughput_window": 5})
...
def test_calculate_throughput_with_narrower_window(query_manager, settings, results):
    ...
    settings = extend_dict(settings, {"throughput_frequency": "D", "throughput_window": 2})
