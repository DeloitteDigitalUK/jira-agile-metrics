...
def minimal_cycle_time_results(minimal_cycle_time_columns):
    ...
    return {
        CycleTimeCalculator: DataFrame(_issues([
            ...
            dict(Backlog=_ts('2018-01-03'), Committed=_ts('2018-01-03'), Build=_ts('2018-01-04'),
                 Test=_ts('2018-01-05'), Done=_ts('2018-01-06')),
...
def large_cycle_time_results(minimal_cycle_time_columns):
    ...
    return {
        CycleTimeCalculator: DataFrame(_issues([
            ...
            dict(Backlog=_ts('2018-01-01'), Committed=_ts('2018-01-02'), Build=_ts('2018-01-03'),
                 Test=_ts('2018-01-04'), Done=NaT),
            dict(Backlog=_ts('2018-01-01'), Committed=_ts('2018-01-02'), Build=_ts('2018-01-03'),
                 Test=_ts('2018-01-05'), Done=NaT),
            dict(Backlog=_ts('2018-01-01'), Committed=_ts('2018-01-02'), Build=_ts('2018-01-03'),
                 Test=_ts('2018-01-05'), Done=NaT),

            # six issues done, with different cycle times
            dict(Backlog=_ts('2018-01-01'), Committed=_ts('2018-01-02'), Build=_ts('2018-01-03'),
                 Test=_ts('2018-01-04'), Done=_ts('2018-01-07')),
            dict(Backlog=_ts('2018-01-01'), Committed=_ts('2018-01-02'), Build=_ts('2018-01-03'),
                 Test=_ts('2018-01-05'), Done=_ts('2018-01-07')),
            dict(Backlog=_ts('2018-01-01'), Committed=_ts('2018-01-03'), Build=_ts('2018-01-03'),
                 Test=_ts('2018-01-05'), Done=_ts('2018-01-08')),
            dict(Backlog=_ts('2018-01-01'), Committed=_ts('2018-01-03'), Build=_ts('2018-01-03'),
                 Test=_ts('2018-01-04'), Done=_ts('2018-01-08')),
            dict(Backlog=_ts('2018-01-01'), Committed=_ts('2018-01-04'), Build=_ts('2018-01-05'),
                 Test=_ts('2018-01-05'), Done=_ts('2018-01-09')),
            dict(Backlog=_ts('2018-01-01'), Committed=_ts('2018-01-05'), Build=_ts('2018-01-06'),
                 Test=_ts('2018-01-08'), Done=_ts('2018-01-09')),
        ]), columns=minimal_cycle_time_columns)
    }
...
def mock_trello_api(mocker):
    ...
    mock_cards.get.side_effect = [{
        ...
        u'badges': {u'votes': 0, u'attachments': 0, u'subscribed': False, u'due': None, u'comments': 0,
                    u'checkItemsChecked': 0, u'fogbugz': u'', u'viewingMemberVoted': False, u'checkItems': 0,
                    u'description': False},
    ...
    mock_boards.get_action.side_effect = [
        [{u'type': u'updateCard', u'idMemberCreator': u'559248f3a0cca5aeb0277db6',
          u'memberCreator': {u'username': u'worldofchris', u'fullName': u'Chris Young', u'initials': u'CY',
                             u'id': u'559248f3a0cca5aeb0277db6',
                             u'avatarHash': u'1171b29b10de82b6a77187b79d8b9a41'},
          u'date': u'2016-01-31T16:24:36.269Z',
          u'data': {u'listBefore': {u'name': u'Three', u'id': u'56ae35296061372e997c0321'},
                    u'old': {u'idList': u'56ae35296061372e997c0321'},
                    u'board': {u'id': u'56ae35260b361ede7bfbb1ba', u'name': u'API Test 001',
                               u'shortLink': u'l4YiX1fv'},
                    u'card': {u'idShort': 1, u'id': u'56ae35346b23ea1d6843a67f', u'name': u'Card One',
                              u'idList': u'56ae352bee563becb21b3b82', u'shortLink': u'J6st5pG8'},
                    u'listAfter': {u'name': u'Four', u'id': u'56ae352bee563becb21b3b82'}},
          u'id': u'56ae35444acfaca041099908'},
         {u'type': u'moveCardToBoard', u'idMemberCreator': u'559248f3a0cca5aeb0277db6',
          u'memberCreator': {u'username': u'worldofchris', u'fullName': u'Chris Young', u'initials': u'CY',
                             u'id': u'559248f3a0cca5aeb0277db6',
                             u'avatarHash': u'1171b29b10de82b6a77187b79d8b9a41'},
          u'date': u'2016-01-31T16:24:29.768Z',
          u'data': {u'boardSource': {u'name': u'API Test 000', u'id': u'56ae351097460cd456a5f323'},
                    u'list': {u'name': u'Three', u'id': u'56ae35296061372e997c0321'},
                    u'board': {u'id': u'56ae35260b361ede7bfbb1ba', u'name': u'API Test 001',
                               u'shortLink': u'l4YiX1fv'},
                    u'card': {u'idShort': 1, u'id': u'56ae35346b23ea1d6843a67f', u'name': u'Card One',
                              u'shortLink': u'J6st5pG8'}}, u'id': u'56ae353d1fd6686e1baa1d93'},
         {u'type': u'createCard', u'idMemberCreator': u'559248f3a0cca5aeb0277db6',
          u'memberCreator': {u'username': u'worldofchris', u'fullName': u'Chris Young', u'initials': u'CY',
                             u'id': u'559248f3a0cca5aeb0277db6',
                             u'avatarHash': u'1171b29b10de82b6a77187b79d8b9a41'},
          u'date': u'2016-01-31T16:24:20.398Z',
          u'data': {u'list': {u'name': u'List One', u'id': u'56ae3514326fd4436da31bbf'},
                    u'board': {u'name': u'API Test 001', u'id': u'56ae35260b361ede7bfbb1ba'},
                    u'card': {u'idShort': 1, u'id': u'56ae35346b23ea1d6843a67f', u'name': u'Card One',
                              u'shortLink': u'J6st5pG8'}}, u'id': u'56ae35346b23ea1d6843a680'},
         {u'type': u'createList', u'idMemberCreator': u'559248f3a0cca5aeb0277db6',
          u'memberCreator': {u'username': u'worldofchris', u'fullName': u'Chris Young', u'initials': u'CY',
                             u'id': u'559248f3a0cca5aeb0277db6',
                             u'avatarHash': u'1171b29b10de82b6a77187b79d8b9a41'},
          u'date': u'2016-01-31T16:24:11.845Z',
          u'data': {u'list': {u'name': u'Four', u'id': u'56ae352bee563becb21b3b82'},
                    u'board': {u'id': u'56ae35260b361ede7bfbb1ba', u'name': u'API Test 001',
                               u'shortLink': u'l4YiX1fv'}}, u'id': u'56ae352bee563becb21b3b83'},
         {u'type': u'createList', u'idMemberCreator': u'559248f3a0cca5aeb0277db6',
          u'memberCreator': {u'username': u'worldofchris', u'fullName': u'Chris Young', u'initials': u'CY',
                             u'id': u'559248f3a0cca5aeb0277db6',
                             u'avatarHash': u'1171b29b10de82b6a77187b79d8b9a41'},
          u'date': u'2016-01-31T16:24:09.766Z',
          u'data': {u'list': {u'name': u'Three', u'id': u'56ae35296061372e997c0321'},
                    u'board': {u'id': u'56ae35260b361ede7bfbb1ba', u'name': u'API Test 001',
                               u'shortLink': u'l4YiX1fv'}}, u'id': u'56ae35296061372e997c0322'},
         {u'type': u'createBoard', u'idMemberCreator': u'559248f3a0cca5aeb0277db6',
          u'memberCreator': {u'username': u'worldofchris', u'fullName': u'Chris Young', u'initials': u'CY',
                             u'id': u'559248f3a0cca5aeb0277db6',
                             u'avatarHash': u'1171b29b10de82b6a77187b79d8b9a41'},
          u'date': u'2016-01-31T16:24:06.359Z', u'data': {
          u'board': {u'id': u'56ae35260b361ede7bfbb1ba', u'name': u'API Test 001',
                        u'shortLink': u'l4YiX1fv'}}, u'id': u'56ae35260b361ede7bfbb1bc'},
         {u'type': u'createCard', u'idMemberCreator': u'559248f3a0cca5aeb0277db6',
          u'memberCreator': {u'username': u'worldofchris', u'fullName': u'Chris Young', u'initials': u'CY',
                             u'id': u'559248f3a0cca5aeb0277db6',
                             u'avatarHash': u'1171b29b10de82b6a77187b79d8b9a41'},
          ...
          u'data': {u'list': {u'name': u'List One', u'id': u'56ae3514326fd4436da31bbf'},
                    u'board': {u'name': u'API Test 001', u'id': u'56ae35260b361ede7bfbb1ba'},
                    u'card': {u'idShort': 1, u'id': u'56ae35346b23ea1d6843a67a', u'name': u'Card Two',
                              u'shortLink': u'J6st5pG8'}}, u'id': u'56ae35346b23ea1d6843a680'}
         ],
        []
    ]
