...
from .cli import (
    validate_csv_calculator_compatibility,
    run_command_line,
...
class TestCLICSVIntegration:
    ...
    def test_cli_with_csv_file_safe_config(self, mock_csv_source, mock_query_manager, mock_run_calculators, csv_file, minimal_config):
    ...
    @patch('jira_agile_metrics.cli.QueryManager') 
    @patch('jira_agile_metrics.cli.CSVDataSource')
    def test_cli_with_csv_file_unsafe_config(self, mock_csv_source, mock_query_manager, mock_run_calculators, csv_file, config_with_unsafe_calculators):
    ...
    def test_cli_without_csv_file_unsafe_config(self, mock_get_jira_client, mock_query_manager, mock_run_calculators, config_with_unsafe_calculators):
