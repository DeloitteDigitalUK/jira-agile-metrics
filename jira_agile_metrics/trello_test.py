...
from .trello import TrelloClient, JiraLikeHistoryItem, JiraLikeHistory, JiraLikeIssue, JiraLikeFields
...
def test_search_issues(mock_trello_api):
    ...
    when it transitions from one Board to another for security reasons.
...
def test_jira_like_history_item():
    ...
    my_item = JiraLikeHistoryItem(field='status',
                                  fromString='Open',
                                  toString='Closed')
...
def test_jira_like_history():
    ...
    my_history = JiraLikeHistory(created='',
                                 item=JiraLikeHistoryItem(field='status',
                                                          fromString='Open',
                                                          toString='Closed'))
...
def test_jira_like_issue():
    ...
    """
    my_jira_like_issue = JiraLikeIssue(key="some number",
                                       url="https://some.where",
                                       fields=None,
                                       history=JiraLikeHistory(created='',
                                                               item=JiraLikeHistoryItem(field='status',
                                                                                        fromString='Open',
                                                                                        toString='Closed')))
...
def test_jira_like_fields():
    ...
    """
    my_jira_fields = JiraLikeFields(labels=['this', 'that', 'the other'],
