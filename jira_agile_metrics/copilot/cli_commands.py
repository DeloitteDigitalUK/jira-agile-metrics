...
class AIInsightsCommand:
    ...
    def validate_prerequisites(self, context_file: str) -> Tuple[bool, str]:
        ...
        if not os.path.exists(context_file):
            return False, f"Context file not found: {context_file}. Run regular metrics analysis first."
        
        return True, ""
    
    def generate_insights(self, context_file: str, output_file: str = 'daily-insights.md') -> Tuple[bool, str, str]:
        """
        ...
        try:
            ...
            insights = generator.generate_daily_insights(context_file, output_file)
