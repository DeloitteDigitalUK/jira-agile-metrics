...
def configure_argument_parser():
    ...
    parser.add_argument(
        "-n", metavar="N", dest="max_results", type=int, help="Only fetch N most recently updated issues"
    )

    parser.add_argument(
        "--server",
        metavar="127.0.0.1:8080",
        help="Run as a web server instead of a command line tool, on the given host and/or port. "
