...
def configure_argument_parser():
    ...
    parser.add_argument('--defects-by-priority-chart-field', metavar='Priority', help="Name of field identifying defect priority")
    parser.add_argument('--defects-by-priority-chart-values', metavar='"Low,Medium,High"', type=to_list, help="List of valid values, in order, for defect priorities")
    ...
    parser.add_argument('--defects-by-type-chart-field', metavar='Priority', help="Name of field identifying defect type")
    parser.add_argument('--defects-by-type-chart-values', metavar='"Requirements,Enironmental,Code"', type=to_list, help="List of valid values, in order, for defect values")
    ...
    parser.add_argument('--defects-by-environment-chart-field', metavar='Priority', help="Name of field identifying the environment in which a defect was discovered")
    parser.add_argument('--defects-by-environment-chart-values', metavar='"SIT,UAT,Prod"', type=to_list, help="List of valid values, in order, for defect environments")
    ...
    parser.add_argument('--debt-chart-query', metavar='"issueType=Debt"', help="JQL query used to identify technical debt items")
    parser.add_argument('--debt-chart-title', metavar='Technical debt', help="Title for the technical debt chart")
    parser.add_argument('--debt-chart-priority-field', metavar='Priority', help="Name of field identifying technical debt item priority")
    parser.add_argument('--debt-chart-priority-values', metavar='"Low,Medium,High"', type=to_list, help="List of valid values, in order, for technical debt item priorities")
    parser.add_argument('--debt-chart-frequency', metavar='1MS', default="1MS", help="Frequency to use when grouping historical technical debt item counts. Defaults to monthly.")
    parser.add_argument('--debt-chart-window', metavar=6, type=int, default=6, help="How many periods to show.")
    ...
    parser.add_argument('--waste-chart-query', metavar='"issueType=Story AND resolution=Withdrawn"', help="JQL query used to identify waste items, e.g. those withdrawn after work has begun")
    parser.add_argument('--waste-chart-title', metavar='Waste', help="Title for the waste chart")
    parser.add_argument('--waste-chart-frequency', metavar='1MS', default="1MS", help="Frequency to use when grouping historical waste counts. Defaults to monthly.")
    parser.add_argument('--waste-chart-window', metavar=6, type=int, default=6, help="How many periods to show.")
