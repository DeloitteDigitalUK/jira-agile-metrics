...
This will read the AI context file, send the structured data to your chosen LLM provider, and save the generated insights to an output file. You can use the `--copilot-context` command line option to provide a specific context file. It will default to the file generated by the export step as specified in the configuration.
